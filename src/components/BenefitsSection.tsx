...
const BenefitsSection: React.FC = () => {
  ...
  // Testimonial data - 10 different marketing personalization success stories
  const marketingTestimonials = [
    {
      quote: "We increased sales by 287% with personalized marketing video campaigns. The ability to tailor messages to specific buyer personas revolutionized our approach.",
      name: "Alex Rodriguez",
    ...
    {
      quote: "After implementing segment-specific video marketing, our email open rates jumped from 22% to 58%, and our click-through rates tripled virtually overnight.",
      name: "Sarah Johnson",
    ...
    {
      quote: "As a SaaS company, we're now delivering personalized onboarding videos to each customer segment. Reduced support tickets by 47% while improving activation rates by 83%.",
      name: "Emily Drake",
