...
const DashboardToolsSection: React.FC = () => {
  ...
  return (
    <section id="dashboard-tools" className="py-20 bg-black relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-300">
            Access your personalized marketing tools and create content that drives results
          </p>
        </motion.div>
          ...
          <div className="max-w-3xl mx-auto">
            <MagicSparkles minSparkles={3} maxSparkles={6}>
              <h2 className="text-2xl font-bold text-white mb-4">
                Unlock Advanced Marketing Features
              </h2>
            </MagicSparkles>
            
            <p className="text-xl text-gray-300 mb-8">
              Upgrade to Pro to access advanced personalization features and unlimited usage
            </p>
