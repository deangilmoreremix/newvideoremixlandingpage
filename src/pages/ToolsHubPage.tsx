...
const categories = [
  ...
  { id: 'visual', name: 'Visual Creation' },
  { id: 'sales', name: 'Sales Tools' },
  { id: 'page', name: 'Page Builder' },
  { id: 'client', name: 'Client Tools' },
  { id: 'communication', name: 'Communication' },
  { id: 'ai', name: 'Advanced AI' }
];
...
const featuredCollections = [
  ...
  },
  {
    ...
    tools: ['page-planner', 'multi-language', 'meme-generator', 'follow-up-emails'],
